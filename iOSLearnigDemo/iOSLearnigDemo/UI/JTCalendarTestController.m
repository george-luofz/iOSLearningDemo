...
- (void)_test1{
    ...
    _calendarContentView = [[JTHorizontalCalendarView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_calendarMenuView.frame), self.view.nn_width, self.view.nn_height - CGRectGetMaxY(_calendarMenuView.frame))];

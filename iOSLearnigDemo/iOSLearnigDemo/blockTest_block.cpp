...
struct __test_block_block_impl_0 {
  struct __block_impl impl;
  struct __test_block_block_desc_0* Desc;
  __Block_byref_a_0 *a; // by ref
  __test_block_block_impl_0(void *fp, struct __test_block_block_desc_0 *desc, __Block_byref_a_0 *_a, int flags=0) : a(_a->__forwarding) {
...
static void __test_block_block_func_0(struct __test_block_block_impl_0 *__cself) {
  __Block_byref_a_0 *a = __cself->a; // bound by ref
        printf("block in:%p",&(a->__forwarding->a));
    }
static void __test_block_block_copy_0(struct __test_block_block_impl_0*dst, struct __test_block_block_impl_0*src) {_Block_object_assign((void*)&dst->a, (void*)src->a, 8/*BLOCK_FIELD_IS_BYREF*/);}
static void __test_block_block_dispose_0(struct __test_block_block_impl_0*src) {_Block_object_dispose((void*)src->a, 8/*BLOCK_FIELD_IS_BYREF*/);}
static struct __test_block_block_desc_0 {
  size_t reserved;
  size_t Block_size;
  void (*copy)(struct __test_block_block_impl_0*, struct __test_block_block_impl_0*);
  void (*dispose)(struct __test_block_block_impl_0*);
} __test_block_block_desc_0_DATA = { 0, sizeof(struct __test_block_block_impl_0), __test_block_block_copy_0, __test_block_block_dispose_0};
void test_block(){

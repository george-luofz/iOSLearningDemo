...
struct __test_block_block_impl_0 {
  ...
  int a;
  __test_block_block_impl_0(void *fp, struct __test_block_block_desc_0 *desc, int _a, int flags=0) : a(_a) {
...
static struct __test_block_block_desc_0 {
  size_t reserved;
  size_t Block_size;
} __test_block_block_desc_0_DATA = { 0, sizeof(struct __test_block_block_impl_0)};
void test_block(){
    int a = 0;
    printf("block before:%p",&a);
    void (*func)(void) = ((void (*)())&__test_block_block_impl_0((void *)__test_block_block_func_0, &__test_block_block_desc_0_DATA, a));

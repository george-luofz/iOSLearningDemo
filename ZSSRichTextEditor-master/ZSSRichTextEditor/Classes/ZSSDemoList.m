...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0) {
        ...
        cell.textLabel.text = @"placeHolder style";
        cell.detailTextLabel.text = @"with placeHolder";
    } else if (indexPath.row == 7){
        cell.textLabel.text = @"custom editor";
        cell.detailTextLabel.text = @"with placeHolder";
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        RichEditorTestViewController *demo6 = [[RichEditorTestViewController alloc] init];
        [self.navigationController pushViewController:demo6 animated:YES];
    }

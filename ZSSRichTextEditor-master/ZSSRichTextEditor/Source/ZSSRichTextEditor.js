...
zss_editor.current_avtiveElement;
/**
...
zss_editor.backuprange = function(){
    zss_editor.current_avtiveElement = document.activeElement;
    ...
    console.log("bacuprange current global sel s: "+range.startContainer+"sOffset: "+range.startOffset+"e: "+range.endContainer+"eOffset: "+range.endOffset);
}
...
zss_editor.restorerange = function(){
    ...
    console.log('2. window.selection: '+selection.toString());
    console.log('window.selection.range s:'+range.startOffset+'e:'+range.endOffset);
    
    zss_editor.focusEditor();// 添加焦点
}
...
zss_editor.setFontSize = function(fontSize) {
    zss_editor.restorerange();
    document.execCommand("styleWithCSS", null, true);
    document.execCommand("fontSize", 0, fontSize);
    document.execCommand("styleWithCSS", null, false);
    zss_editor.enabledEditingItems();
...
//        console.log('typdef undefined');
        // The target element
        var s = zss_editor.getSelectedNode();
        var t = $(s);
//        console.log('get selectedNode '+t);

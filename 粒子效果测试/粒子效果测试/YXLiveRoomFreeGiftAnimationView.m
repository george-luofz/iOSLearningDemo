...
//    [NSObject cancelPreviousPerformRequestsWithTarget:self];
    ...
    self.rocketCell.birthRate = 1.f;
//    self.burst.birthRate = 1.f;
    self.animationStatus = YXLiveRoomFreeGiftAnimationStatusPlaying;
}

- (void)stopAnimation{
    self.emitterLayer.birthRate = 0.f;
//    [self.emitterLayer removeFromSuperlayer];
    self.rocketCell.birthRate = 0.f;
//    self.burst.birthRate = 0.f;
...
//    fireworksEmitter.frame = self.bounds;
    ...
    rocket.birthRate        = 1 / self.animationLifeTime;
